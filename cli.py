...
def psh_seed():
    ...
    for c in categories:
        ...
        category.save()
    admin = User(first_name="Police", surname="Admin", email="admin@police.com", role_id=6, is_active=1)
    admin.set_password("admin")
    admin.save()
    justin = User(first_name="Justin", surname="Lo", email="justin@gmail.com", role_id=1, is_active=1)
    justin.set_password("justin")
    justin.save()
    hendrik = User(first_name="Hendrik", surname="Rooyen", email="hendrik@police.com", role_id=3, is_active=1)
