...
def threat():
    try:
        ...
        if current_user.role_id == 1:
            ...
            return render_template("citizen.html", title='Home Page', threats=threats, comments=comments, userRoles=userRoles, caseCount=caseCount, form=form)
        # police roles
            ...
            return render_template("approver.html", title="Home Page", userRoles=userRoles, threats=threats, comments=comments, caseCount=caseCount, threatCategories=threatCategories, form=form)
            ...
            if current_user.role_id == 2:
                ...
                return render_template("developer.html", title="Home Page", userRoles=userRoles, threats=threats, comments=comments, threatCategories=threatCategories, form=form)
