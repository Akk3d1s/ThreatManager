...
def threat():
    ...
    # police roles
        ...
        return render_template("temp.html", title="Home Page", userRoles=userRoles, threats=threats, comments=comments, caseCount=caseCount, threatCategories=threatCategories, form=form)
